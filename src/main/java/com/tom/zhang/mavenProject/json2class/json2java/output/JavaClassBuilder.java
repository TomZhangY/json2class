...
public class JavaClassBuilder {
     ...
     * @return
     */
    public HashMap.Entry<String, StringBuilder> buildJavaClass() {
        ...
        return new HashMap.SimpleEntry<String, StringBuilder>(fileName, sb);
    }

    private void buildCLassEnd(StringBuilder sb) {
        sb.append("}").append(LINE_END);
    }

    private void buildGetSets(StringBuilder sb) {
    ...
    private void buildClassStart(StringBuilder sb) {
    ...
    private void buildNote(StringBuilder sb) {
